...
<h4 align="center">
  YouTube Interview → AI Analysis → Chinese Hard-Subtitled Shorts<br>
  YouTube 访谈 → AI 智能分析 → 中文硬字幕短视频
</h4>
...
<p align="center">
  ...
  &nbsp;&nbsp;|&nbsp;&nbsp;
  <strong><a href="#-中文文档">中文文档</a></strong>
</p>
...
```
AutoCliper.AI/
├── SKILL.md                        # Agent skill definition (full SOP)
